...
const recentActivities = [
  { id: 1, action: 'Cập nhật kết quả', kpi: 'HPU2-KPI-05', user: 'Phòng Đào tạo', time: '2 giờ trước', type: 'update' },
  { id: 2, action: 'Nộp minh chứng', kpi: 'HPU2-KPI-13', user: 'Phòng KHCN', time: '3 giờ trước', type: 'evidence' },
  { id: 3, action: 'Duyệt đánh giá', kpi: 'HPU2-KPI-22', user: 'Trung tâm CNTT', time: '5 giờ trước', type: 'approve' },
  { id: 4, action: 'Yêu cầu chỉnh sửa', kpi: 'HPU2-KPI-01', user: 'Phòng TCCB', time: '1 ngày trước', type: 'revision' },
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-text-light mt-1">Trường Đại học Sư phạm Hà Nội 2 — {activeYear?.name || ''}</p>
        </div>
