...
import { Plus, Edit, Trash2, Info, Target, TrendingUp, Users, DollarSign, RefreshCw, LayoutDashboard, Settings } from 'lucide-react';
...
type TabKey = 'overview' | 'management';

const tabs: { key: TabKey; label: string; icon: typeof LayoutDashboard }[] = [
  { key: 'overview', label: 'Tổng quan', icon: LayoutDashboard },
  { key: 'management', label: 'Quản lý phối cảnh', icon: Settings },
];
